...
public class BlogController {
    ...
    public static void main(String[] args) throws IOException {
        if (args.length == 0) {
            new BlogController("mongodb://alzanza:ddX5xM08m7t58NaxZMWthwHIOhtdSnuimwIJWOw0mEXcynQIQeKplzvanBjDvGged0WFmkDcN75ZO2ebvyKIzw==@alzanza.documents.azure.com:10255/?ssl=true&replicaSet=globaldb");
        }
        else {
